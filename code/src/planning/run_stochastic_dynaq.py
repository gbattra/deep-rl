...
from lib.planning.mazes import Maze, blocking_maze_end, blocking_maze_start, shortcut_maze_end, shortcut_maze_start
...
def run_stochastic_shortcut_dynaq_plus():
    print('Dyna-Q+')
    env = Maze(
        shortcut_maze_start(),
        shortcut_maze_end(),
...
def run_stochastic_blocking_dynaq_plus():
    print('Dyna-Q+')
    env = Maze(
        blocking_maze_start(),
        blocking_maze_end(),
...
def main():
    run_stochastic_blocking_dynaq_plus()
    # run_stochastic_shortcut_dynaq_plus()
